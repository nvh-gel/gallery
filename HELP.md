...
* [Prometheus](https://docs.spring.io/spring-boot/docs/3.0.0-M2/reference/htmlsingle/#production-ready-metrics-export-prometheus)
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/docs/3.0.0-M2/reference/htmlsingle/#boot-features-kafka)
